...
public abstract class NetworkUtils {
     ...
     */
    @SafeVarargs
    public static Set<NetworkInterface> getNetworkInterfaceCardSet(Predicate<NetworkInterface>... filters) {
        if (null == filters) {
     ...
     * @return
     */
    public static Set<NetworkInterface> getPhysicalNetworkInterfaceCardSet() {
        return getNetworkInterfaceCardSet(Filter.PHYICAL_ONLY, Filter.UP);
    }
